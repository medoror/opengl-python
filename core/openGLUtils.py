...
# static methods to load and compile OpenGK shaders and link to create programs
...
class OpenGLUtils(object):
    ...
    def initializeProgram(vertexShaderCode, fragmentShaderCode):
        ...
        # attach previously compile shader programs
    ...
    def initializeShader(shaderCode, shaderType):
        ...
        # compilatipon was successful; return shader reference value
        return shaderRef
